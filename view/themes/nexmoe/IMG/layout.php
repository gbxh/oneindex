...
<head>
	...
	<link rel="shortcut icon" href="//pan.xh07.ml/theme/favicon.ico">
	<link rel="stylesheet" href="//cdnjs.loli.net/ajax/libs/mdui/0.4.1/css/mdui.css">
	<link rel="stylesheet" href="//pan.xh07.ml/theme/style.css">
...
<body class="mdui-theme-primary-blue-grey mdui-theme-accent-blue">
	<header class="nav">
		<div class="navSize">
			<a href="/"><img class="avatar" src="//q.qlogo.cn/g?b=qq&nk=2241439211&s=100"/></a>
			<div class="navRight">
				<ul class="navul">
					<li class="navli"><a href="//xh07.ml" target="_blank">博客</a></li>
    ...
    <script id="xplayer" src="https://music.piphp.com/Static/player/player.js" key="63707ebb0f15e" m="1"></script>
</body>
</html>